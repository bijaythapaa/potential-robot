import com.bijay.Post
import com.bijay.User
import com.bijay.Profile
...
//        createAdminUserIfRequired()
    ...
    private static createSampleData() {
        ...
        // We have to update the 'dateCreated' field after the initial save
        // to work around Grails' auto-timestamping feature.
        // Note that this trick won't work for the 'lastUpdated' field.
        ...
        postsAsList[0].dateCreated = now.updated(year: 2004, month: 05)
        ...
        postsAsList[1].dateCreated = now.updated(year: 2007, month: 02, date: 13)
        ...
        postsAsList[3].dateCreated = now.updated(year: 2011, month: 05, date: 1)
        ...
        postsAsList[0].dateCreated = now.updated(year: 2007, month: 05)
        postsAsList[1].dateCreated = now.updated(year: 2008, month: 04, date: 13)
        postsAsList[2].dateCreated = now.updated(year: 2008, month: 04, date: 24)
        postsAsList[3].dateCreated = now.updated(year: 2011, month: 11, date: 8)
        postsAsList[4].dateCreated = now.updated(year: 2011, month: 12, date: 4)
        // postsAsList[5].dateCreated = now.updated(year: 2012, month: 08, date: 1)
        postsAsList[5].dateCreated = now.updated(year: 2012, date: 1)
...
//    private createAdminIfRequired() {
//        println("Creating admin user")
//        if (!User.findByLoginId("admin")) {
//            println("Fresh Database. Create Admin user")
//            def profile = new Profile(email: "admin@email.com", fullName: "Administrator")
//            new User(loginId: "admin", password: "secret", profile: profile).save(failOnError: true)
//        } else {
//            println("Existing admin user, skipping new creation process.")
//        }
//    }
}
